...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tdb8y14.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tdb8y14.containers.anotherwebservice.com/
...
```
git clone git@github.com:marcant94/container-tdb8y14.git
cd container-tdb8y14
```
...
```
docker attach container-tdb8y14
```
